...
class Audio extends Component {
  constructor(props) {
     ...
     * worker
     */
    this.audioWorker = typeof window === 'object' && audioWorkerJS()
  ...
  loadSong(url) {
    ...
    if (hasStreamSupport) {
      console.log('fetch and stream', threadInUse)
  ...
  framerDrawTick(x1, y1, x2, y2) {
    ...
    const {colors} = this.props.Imagen.localFiles[0]
    ...
    gradient.addColorStop(0, colors.vibrant)
    gradient.addColorStop(0.6, colors.lightVibrant)
      ...
      <div className="AudioViz">
        <div className="Audio">
          <div className="Player">
            <canvas id="Player-canvas" key="Player-canvas" />
            <div className="rest">
              <div className="song-info">
                <h2 className="song-artist">
                  #ATLAS{this.props.Num} - {this.props.Nombre}
                </h2>
                {/* <div className='song-name'>{this.props.Texto}</div> */}
              </div>
